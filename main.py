...
def main(args):
    ...
    new_folder_path, notes = file_orgnizer.organize_files_in_old_folder(old_folder_path=args.paper_folder_path,
                                                                        new_folder_name=args.new_folder_name,
                                                                        paper_reader=paper_reader)

    if booster:
        file_orgnizer.save_notes_to_files(notes, new_folder_path, args.file_format)


if __name__ == '__main__':
    if __name__ == '__main__':
        parser = argparse.ArgumentParser()
        parser.add_argument("--paper_folder_path", type=str, default='data/demo',
        ...
        parser.add_argument("--booster", type=str, default='False',
